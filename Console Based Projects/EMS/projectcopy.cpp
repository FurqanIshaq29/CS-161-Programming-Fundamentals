...
void topHeader()
{
    char box = 219;
    {
        ...
        cout << "                   " << box << box << box << box << box << box << box << box << "    " << box << box << box << box << box << box << box << box << box << box << box << box << box << box << box << "     " << box << box << box << box << box << box << box << box << box << endl;
        cout << "                   " << box << "           " << box << box << "     " << box << "     " << box << box << "     " << box << endl;
        cout << "                   " << box << "           " << box << box << "     " << box << "     " << box << box << "     " << box << "               " << endl;
        cout << "                   " << box << box << box << box << box << box << box << "     " << box << box << "     " << box << "     " << box << box << "     " << box << box << box << box << box << box << box << box << box << endl;
        cout << "                   " << box << "           " << box << box << "     " << box << "     " << box << box << "             " << box << "       " << endl;
        cout << "                   " << box << "           " << box << box << "     " << box << "     " << box << box << "             " << box << endl;
        cout << "                   " << box << box << box << box << box << box << box << box << "    " << box << box << "     " << box << "     " << box << box << "     " << box << box << box << box << box << box << box << box << box << endl;
        cout << "                                                                  " << endl;
        cout << "              ###############################################     " << endl;
